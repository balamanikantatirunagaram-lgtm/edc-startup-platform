        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-w-5xl">
              ...
              <div className="space-y-6">
                <div className="flex gap-x-4 items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:edc@niat.edu" className="text-muted-foreground hover:text-primary transition-colors">
                      edc@niat.edu
                    </a>
                  </div>
                </div>
          ...
          <div className="bg-background rounded-3xl border shadow-xl p-8 sm:p-10">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block w-full rounded-md border-0 py-2.5 px-3.5 text-foreground shadow-sm ring-1 ring-inset ring-border placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6 bg-background"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium leading-6 text-foreground">
                  Subject
                </label>
                <div className="mt-2">
                  <input
                    ...
                    id="subject"
                    className="block w-full rounded-md border-0 py-2.5 px-3.5 text-foreground shadow-sm ring-1 ring-inset ring-border placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6 bg-background"
                    placeholder="Incubation Inquiry"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    rows={4}
                    className="block w-full rounded-md border-0 py-2.5 px-3.5 text-foreground shadow-sm ring-1 ring-inset ring-border placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6 bg-background"
                    placeholder="Tell us about your startup or inquiry..."
                  />
                </div>
              </div>
