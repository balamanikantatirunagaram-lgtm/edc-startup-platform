const fs = require('fs');
const file = 'src/app/(app)/jobs/page.tsx';
let content = fs.readFileSync(file, 'utf8');

// Add import
content = content.replace(
  'import { getJobPostings, postJobMentor } from "@/services/jobs.service"',
  'import { getJobPostings, postJobMentor, getJobApplications } from "@/services/jobs.service"'
);

// Add icons
content = content.replace(
  'import { Briefcase, MapPin, DollarSign, Loader2, Search, Plus, Building2 } from "lucide-react"',
  'import { Briefcase, MapPin, DollarSign, Loader2, Search, Plus, Building2, Users } from "lucide-react"'
);
...
content = content.replace(
  '<div className="text-xs text-center text-muted-foreground mt-2">Mentors cannot delete jobs</div>',
